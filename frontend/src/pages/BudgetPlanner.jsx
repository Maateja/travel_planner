...
function BudgetPlanner() {
  ...
  const savedPlaces = useMemo(() => [
    // --- HOTELS ---
    { id: 1, name: 'The Taj Mahal Palace', type: 'Hotels', rating: 4.8, location: 'Mumbai, MH', image: '🏨', cost: 12000, members: 2, rooms: 1, studentScore: 6, tags: ['Iconic', 'Luxury', 'Safe'], budgetImpact: '🔴 Expensive', breakdown: { stay: 80, food: 15, transport: 5 } },
    { id: 5, name: 'Rambagh Palace', type: 'Hotels', rating: 4.9, location: 'Jaipur, RJ', image: '🏰', cost: 15000, members: 2, rooms: 1, studentScore: 4, tags: ['Royal', 'Heritage'], budgetImpact: '🔴 Expensive', breakdown: { stay: 85, food: 10, transport: 5 } },
    { id: 17, name: 'Wildflower Hall', type: 'Hotels', rating: 4.8, location: 'Shimla, HP', image: '🌲', cost: 8500, members: 2, rooms: 1, studentScore: 5, tags: ['Mountains', 'Views'], budgetImpact: '🔴 Expensive', breakdown: { stay: 75, food: 15, transport: 10 } },
    { id: 32, name: 'Khyber Resort', type: 'Hotels', rating: 4.7, location: 'Gulmarg, JK', image: '❄️', cost: 7000, members: 2, rooms: 1, studentScore: 6, tags: ['Snow', 'Skiing'], budgetImpact: '🔴 Expensive', breakdown: { stay: 70, food: 20, transport: 10 } },
    { id: 59, name: 'The Tamara Coorg', type: 'Hotels', rating: 4.8, location: 'Coorg, KA', image: '☕', cost: 4500, members: 2, rooms: 1, studentScore: 8, tags: ['Nature', 'Coffee'], budgetImpact: '🟡 Moderate', breakdown: { stay: 65, food: 25, transport: 10 } },
    { id: 62, name: 'Hostel Hayat', type: 'Hotels', rating: 4.4, location: 'Bengaluru, KA', image: '🏙️', cost: 800, members: 1, rooms: 0.5, studentScore: 10, tags: ['Student Favorite', 'Budget'], budgetImpact: '🟢 Friendly', breakdown: { stay: 50, food: 30, transport: 20 } },

    // --- RESTAURANTS ---
    { id: 2, name: 'Bademiya Kebab', type: 'Restaurants', rating: 4.5, location: 'Colaba, Mumbai', image: '🥘', cost: 450, studentScore: 9, tags: ['Cheap Food', 'Street Art'], budgetImpact: '🟢 Friendly', breakdown: { stay: 0, food: 90, transport: 10 } },
    { id: 4, name: 'Leopold Cafe', type: 'Restaurants', rating: 4.2, location: 'Colaba, Mumbai', image: '☕', cost: 600, studentScore: 8, tags: ['Historic', 'Students'], budgetImpact: '🟡 Moderate', breakdown: { stay: 0, food: 85, transport: 15 } },
    { id: 40, name: 'Vidyarthi Bhavan', type: 'Restaurants', rating: 4.8, location: 'Bengaluru, KA', image: '🍘', cost: 120, studentScore: 10, tags: ['Near Colleges', 'Legendary'], budgetImpact: '🟢 Friendly', breakdown: { stay: 0, food: 95, transport: 5 } },
    { id: 63, name: 'Blue Poppy', type: 'Restaurants', rating: 4.5, location: 'Kolkata, WB', image: '🥟', cost: 350, studentScore: 9, tags: ['Best Momos', 'Cheap Eats'], budgetImpact: '🟢 Friendly', breakdown: { stay: 0, food: 90, transport: 10 } },

    // --- ATTRACTIONS ---
    { id: 3, name: 'Gateway of India', type: 'Attractions', rating: 4.7, location: 'Mumbai, MH', image: '📸', cost: 0, studentScore: 10, tags: ['Free Entry', 'Instagram'], budgetImpact: '🟢 Friendly', breakdown: { stay: 0, food: 30, transport: 70 } },
    { id: 7, name: 'Taj Mahal', type: 'Attractions', rating: 5.0, location: 'Agra, UP', image: '🏛️', cost: 1100, studentScore: 7, tags: ['Must Visit', 'Heritage'], budgetImpact: '🔴 Expensive', breakdown: { stay: 0, food: 40, transport: 60 } },
    { id: 16, name: 'Golden Temple', type: 'Attractions', rating: 4.9, location: 'Amritsar, PB', image: '✨', cost: 0, studentScore: 10, tags: ['Spiritual', 'Free Food'], budgetImpact: '🟢 Friendly', breakdown: { stay: 0, food: 10, transport: 90 } },
    { id: 21, name: 'Munnar Tea Gardens', type: 'Attractions', rating: 4.7, location: 'Munnar, KL', image: '🍃', cost: 200, studentScore: 9, tags: ['Nature', 'Cheap Spots'], budgetImpact: '🟢 Friendly', breakdown: { stay: 0, food: 20, transport: 80 } },
    
    // --- HYDERABAD SPECIALS ---
    { id: 101, name: 'ITC Kohenur', type: 'Hotels', rating: 4.8, location: 'Hyderabad, TS', image: '💎', cost: 9500, members: 2, rooms: 1, studentScore: 7, tags: ['Luxury', 'Business'], budgetImpact: '🔴 Expensive', breakdown: { stay: 80, food: 15, transport: 5 } },
    { id: 102, name: 'Paradise Biryani', type: 'Restaurants', rating: 4.6, location: 'Secunderabad, Hyderabad', image: '🍗', cost: 500, studentScore: 9, tags: ['Legendary', 'Biryani'], budgetImpact: '🟢 Friendly', breakdown: { stay: 0, food: 90, transport: 10 } },
    { id: 103, name: 'Charminar', type: 'Attractions', rating: 4.9, location: 'Hyderabad, TS', image: '🕌', cost: 50, studentScore: 10, tags: ['Historic', 'Iconic'], budgetImpact: '🟢 Friendly', breakdown: { stay: 0, food: 20, transport: 80 } },
    { id: 104, name: 'Hyderabad Metro Hub', type: 'Attractions', rating: 4.5, location: 'Ameerpet, Hyderabad', image: '🚇', cost: 40, studentScore: 10, tags: ['Transport', 'Connected'], budgetImpact: '🟢 Friendly', breakdown: { stay: 0, food: 10, transport: 90 } },
    
    // --- TRIVANDRUM FALLBACKS ---
    { id: 201, name: 'Hyatt Regency Trivandrum', type: 'Hotels', rating: 4.7, location: 'Trivandrum, KL', image: '🏨', cost: 7500, members: 2, rooms: 1, studentScore: 6, tags: ['Modern', 'Luxury'], budgetImpact: '🔴 Expensive', breakdown: { stay: 80, food: 15, transport: 5 } },
    { id: 202, name: 'Zam Zam Restaurant', type: 'Restaurants', rating: 4.5, location: 'Palayam, Trivandrum', image: '🥘', cost: 400, studentScore: 9, tags: ['Famous', 'Non-Veg'], budgetImpact: '🟢 Friendly', breakdown: { stay: 0, food: 90, transport: 10 } },
    { id: 203, name: 'Padmanabhaswamy Temple', type: 'Attractions', rating: 4.9, location: 'Trivandrum, KL', image: '🛕', cost: 0, studentScore: 10, tags: ['Iconic', 'Free'], budgetImpact: '🟢 Friendly', breakdown: { stay: 0, food: 20, transport: 80 } },
    { id: 204, name: 'Napier Museum', type: 'Attractions', rating: 4.6, location: 'Trivandrum, KL', image: '🏛️', cost: 20, studentScore: 10, tags: ['Heritage', 'Student Entry'], budgetImpact: '🟢 Friendly', breakdown: { stay: 0, food: 10, transport: 90 } },
    { id: 205, name: 'KSRTC City Hub', type: 'Attractions', rating: 4.4, location: 'East Fort, Trivandrum', image: '🚌', cost: 15, studentScore: 10, tags: ['Local Bus', 'Cheap Transport'], budgetImpact: '🟢 Friendly', breakdown: { stay: 0, food: 5, transport: 95 } },

    // --- MANALI FALLBACKS ---
    { id: 301, name: 'The Himalayan', type: 'Hotels', rating: 4.8, location: 'Manali, HP', image: '🏔️', cost: 6500, members: 2, rooms: 1, studentScore: 7, tags: ['Views', 'Castle'], budgetImpact: '🔴 Expensive', breakdown: { stay: 70, food: 20, transport: 10 } },
    { id: 302, name: 'Johnson Cafe', type: 'Restaurants', rating: 4.4, location: 'Old Manali', image: '🎸', cost: 800, studentScore: 8, tags: ['Music', 'Trout'], budgetImpact: '🟡 Moderate', breakdown: { stay: 0, food: 85, transport: 15 } },
    { id: 303, name: 'Solang Valley', type: 'Attractions', rating: 4.7, location: 'Manali, HP', image: '⛷️', cost: 500, studentScore: 9, tags: ['Adventure', 'Snow'], budgetImpact: '🟡 Moderate', breakdown: { stay: 0, food: 30, transport: 70 } },

    // --- GOA FALLBACKS ---
    { id: 401, name: 'W Goa', type: 'Hotels', rating: 4.6, location: 'Vagator, Goa', image: '🏖️', cost: 18000, members: 2, rooms: 1, studentScore: 5, tags: ['Beachfront', 'Party'], budgetImpact: '🔴 Expensive', breakdown: { stay: 85, food: 10, transport: 5 } },
    { id: 402, name: 'Curlies Beach Shack', type: 'Restaurants', rating: 4.3, location: 'Anjuna, Goa', image: '🍹', cost: 1200, studentScore: 8, tags: ['Hippie', 'Sunsets'], budgetImpact: '🟡 Moderate', breakdown: { stay: 0, food: 70, transport: 30 } },
    { id: 403, name: 'Fort Aguada', type: 'Attractions', rating: 4.5, location: 'Candolim, Goa', image: '🏰', cost: 0, studentScore: 10, tags: ['History', 'Free'], budgetImpact: '🟢 Friendly', breakdown: { stay: 0, food: 10, transport: 90 } },

    // --- MADANAPALLE FALLBACKS ---
    { id: 501, name: 'SSR Residency', type: 'Hotels', rating: 4.2, location: 'Madanapalle, AP', image: '🏨', cost: 1200, members: 2, rooms: 1, studentScore: 9, tags: ['Budget', 'Main Road'], budgetImpact: '🟢 Friendly', breakdown: { stay: 85, food: 10, transport: 5 } },
    { id: 505, name: 'Hotel Srinivaas', type: 'Hotels', rating: 4.0, location: 'Madanapalle, AP', image: '🛌', cost: 1500, members: 2, rooms: 1, studentScore: 8, tags: ['Central', 'Clean'], budgetImpact: '🟢 Friendly', breakdown: { stay: 80, food: 15, transport: 5 } },
    { id: 502, name: 'B.T. College', type: 'Attractions', rating: 4.5, location: 'Madanapalle, AP', image: '🎓', cost: 0, studentScore: 10, tags: ['Historic', 'Campus'], budgetImpact: '🟢 Friendly', breakdown: { stay: 0, food: 20, transport: 80 } },
    { id: 503, name: 'Horsley Hills', type: 'Attractions', rating: 4.8, location: 'Near Madanapalle', image: '⛰️', cost: 100, studentScore: 10, tags: ['Hill Station', 'Nature'], budgetImpact: '🟢 Friendly', breakdown: { stay: 0, food: 30, transport: 70 } },
    { id: 506, name: 'Rishi Valley School', type: 'Attractions', rating: 4.6, location: 'Madanapalle, AP', image: '🏫', cost: 0, studentScore: 9, tags: ['Educational', 'Iconic'], budgetImpact: '🟢 Friendly', breakdown: { stay: 0, food: 10, transport: 90 } },
    { id: 504, name: 'Nandini Restaurant', type: 'Restaurants', rating: 4.1, location: 'Madanapalle, AP', image: '🍛', cost: 250, studentScore: 10, tags: ['South Indian', 'Cheap'], budgetImpact: '🟢 Friendly', breakdown: { stay: 0, food: 95, transport: 5 } },
    { id: 507, name: 'New Highway Biryani', type: 'Restaurants', rating: 4.3, location: 'Madanapalle, AP', image: '🍗', cost: 350, studentScore: 9, tags: ['Biryani', 'Students'], budgetImpact: '🟢 Friendly', breakdown: { stay: 0, food: 90, transport: 10 } },
    { id: 508, name: 'Coffee Day Madanapalle', type: 'Restaurants', rating: 4.0, location: 'Madanapalle, AP', image: '☕', cost: 300, studentScore: 8, tags: ['Hangout', 'Cafe'], budgetImpact: '🟡 Moderate', breakdown: { stay: 0, food: 80, transport: 20 } },

    // --- CHENNAI FALLBACKS ---
    { id: 601, name: 'ITC Grand Chola', type: 'Hotels', rating: 4.9, location: 'Guindy, Chennai', image: '🏛️', cost: 12000, members: 2, rooms: 1, studentScore: 5, tags: ['Palatial', 'Luxury'], budgetImpact: '🔴 Expensive', breakdown: { stay: 85, food: 10, transport: 5 } },
    { id: 602, name: 'Ginger Hotel Chennai', type: 'Hotels', rating: 4.0, location: 'IITM Research Park', image: '🏨', cost: 3500, members: 2, rooms: 1, studentScore: 9, tags: ['Safe', 'Budget'], budgetImpact: '🟢 Friendly', breakdown: { stay: 75, food: 20, transport: 5 } },
    { id: 603, name: 'Holiday Inn Express', type: 'Hotels', rating: 4.2, location: 'OMR, Chennai', image: '🛏️', cost: 4500, members: 2, rooms: 1, studentScore: 8, tags: ['Modern', 'Student Area'], budgetImpact: '🟡 Moderate', breakdown: { stay: 80, food: 15, transport: 5 } },
    { id: 604, name: 'Treebo Trend Trend', type: 'Hotels', rating: 3.8, location: 'T. Nagar, Chennai', image: '🏠', cost: 2200, members: 2, rooms: 1, studentScore: 9, tags: ['Central', 'Affordable'], budgetImpact: '🟢 Friendly', breakdown: { stay: 85, food: 10, transport: 5 } },
    { id: 605, name: 'Murugan Idli Shop', type: 'Restaurants', rating: 4.5, location: 'Besant Nagar', image: '🍛', cost: 300, studentScore: 10, tags: ['Famous', 'Authentic'], budgetImpact: '🟢 Friendly', breakdown: { stay: 0, food: 95, transport: 5 } },
    { id: 606, name: 'Marina Beach Sundal', type: 'Restaurants', rating: 4.4, location: 'Marina Beach', image: '🐚', cost: 50, studentScore: 10, tags: ['Street Food', 'Iconic'], budgetImpact: '🟢 Friendly', breakdown: { stay: 0, food: 50, transport: 50 } },
    { id: 607, name: 'Amelies Cafe', type: 'Restaurants', rating: 4.2, location: 'Alwarpet, Chennai', image: '🍕', cost: 800, studentScore: 8, tags: ['Aesthetic', 'Hangout'], budgetImpact: '🟡 Moderate', breakdown: { stay: 0, food: 90, transport: 10 } },
    { id: 608, name: 'Marina Beach', type: 'Attractions', rating: 4.7, location: 'Chennai, TN', image: '🏖️', cost: 0, studentScore: 10, tags: ['Beach', 'Free'], budgetImpact: '🟢 Friendly', breakdown: { stay: 0, food: 40, transport: 60 } },
    { id: 609, name: 'Guindy National Park', type: 'Attractions', rating: 4.3, location: 'Chennai, TN', image: '🦌', cost: 20, studentScore: 10, tags: ['Nature', 'Wildlife'], budgetImpact: '🟢 Friendly', breakdown: { stay: 0, food: 10, transport: 90 } },
    { id: 610, name: 'VGP Universal Kingdom', type: 'Attractions', rating: 4.1, location: 'ECR, Chennai', image: '🎡', cost: 800, studentScore: 7, tags: ['Amusement', 'Fun'], budgetImpact: '🟡 Moderate', breakdown: { stay: 0, food: 30, transport: 70 } },
  ], []);
              ...
              return (
                ...
                >
                  ...
                  <div className="h-48 bg-gray-50 rounded-[32px] flex items-center justify-center text-6xl relative overflow-hidden mb-6">
                     ...
                     <span className="group-hover:scale-110 transition-transform duration-700">{place.image}</span>
               ...
               <div className="flex items-center gap-6">
                  <div className="flex -space-x-4">
                    {selectedForCompare.map(id => {
                      ...
                      return (
                        <div key={id} className="w-14 h-14 bg-white rounded-2xl border-4 border-gray-900 flex items-center justify-center text-2xl shadow-xl">
                          {p?.image || '📍'}
                        </div>
                      );
                    })}
