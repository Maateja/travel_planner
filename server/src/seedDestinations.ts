...
const REAL_COORDS: { [key: string]: [number, number] } = {
    // Andhra Pradesh
...
const realDestinations: { [key: string]: string[] } = {
...
const generateDestinations = () => {
    ...
    for (const state of states) {
        ...
        for (const cityName of stateDestList) {
            ...
            const template = destinationTemplates[category as keyof typeof destinationTemplates];
